...
import info.akazawa.sample.controller.SimpleController;
...
public class SimpleControllerTests {
    ...
    public void testindex() throws Exception{
    	//コントローラーパスが正しいことを確認
    	MvcResult rslt = mvc.perform(get("/").with(user("akazawa").roles("ADMIN")))
...
//    	assertThat(content,containsString("書籍登録</a>"));
    ...
    public void testlogin() throws Exception{
    	//コントローラーパスが正しいことを確認
    	MvcResult rslt = mvc.perform(get("/login").with(user("akazawa").roles("ADMIN")))
    			.andExpect(status().isOk())
